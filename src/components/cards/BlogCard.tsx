...
function BlogCard({ post }: Props) {
  return (
    <div className="w-full flex flex-row lg:flex-row gap-4 rounded-lg shadow-lg bg-white p-4">
      <div className="w-64 aspect-video relative rounded-xl overflow-hidden">
        <Image
